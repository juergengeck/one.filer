...
describe('SingleUser Test', () => {
    ...
    describe('Register & Erase', () => {
        ...
        it('should test if erase() throws an error when it is called twice', async () => {
            ...
            await chai
                ...
                .to.eventually.be.rejectedWith('Could not erase due to lack of credentials without loging in. The credentials does not exist. Try to login and delete.');
        });
        it('should test if register(secret) throws an error when user already exist', async () => {
            ...
            await chai
                ...
                .to.eventually.be.rejectedWith('Could not register user. The single user already exists.');
        });
    });
    describe('Login & Logout', () => {
        ...
        it('should test if login(secret) throws an error when the user was not registered', async () => {
            ...
            await chai
                ...
                .to.eventually.be.rejectedWith('Error while trying to login. User was not registered.');
        });
        ...
        it.skip('should test if login(secret) throws an error when the user inputs the wrong' +
            ' secret', async () => {
            await singleUserWorkflow.logout();
            await waitForState('logged_out');
            await chai
    ...
    describe('LoginOrRegister', () => {
        ...
        it.skip('should test if loginOrRegister(secret) throws an error when the user was' +

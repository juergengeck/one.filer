...
describe('OEvent test', () => {
    ...
    it('emit sync - check listener handle is called sequentially ', async () => {
        const onEvent = new OEvent(EventTypes.Default, true);
        let handlerCalled1 = false;
        let handlerCalled2 = false;
        let stringVal = null;
        let numberVal = null;
        const disconnect1 = onEvent((emittedStringVal, emittedNumberVal) => {
        ...
        const disconnect2 = onEvent((emittedStringVal, emittedNumberVal) => {
            return new Promise(resolve => {
                setTimeout(() => {
                    handlerCalled2 = true;
                    stringVal = emittedStringVal;
    ...
    it('emit async - check listener handle is called in parallel ', async () => {
        const onEvent = new OEvent(EventTypes.Default, false);
        let handlerCalled1 = false;
        let handlerCalled2 = false;
        let stringVal = null;
        let numberVal = null;
        const disconnect1 = onEvent((emitStringValue, emitNumberValue) => {
            return new Promise(resolve => {
                setTimeout(() => {
                    handlerCalled1 = true;
        ...
        const disconnect2 = onEvent((emitStringValue, emitNumberValue) => {
            return new Promise(resolve => {
                setTimeout(() => {
                    handlerCalled2 = true;
                    stringVal = emitStringValue;
    ...
    it('emitAll async - promise settles when all handlers executed in parallel ', async () => {
        const onStringEvent = new OEvent(EventTypes.Default, false);
        let handlerCalled1 = false;
        let handlerCalled2 = false;
        let handlerCalled3 = false;
        let promiseSettled = false;
    ...
    it('emitRace - promise settles when first handler finishes execution ', async () => {
        const onStringEvent = new OEvent(EventTypes.Default);
...
//# sourceMappingURL=OEvent-test.js.map
...
import { importIdentityFileAsOneInstanceEndpoint, writeNewIdentityToFile, readIdentityFile, readIdentityWithSecretsFile } from '../lib/misc/IdentityExchange-fs.js';
...
describe('identityExchange test one dependent functions', () => {
    ...
    it('create random id', async () => {
        const idOrig = await writeNewIdentityToFile('test/testId/tid', 'ws://localhost:8000');
        const oneInstanceEndpoint = await importIdentityFileAsOneInstanceEndpoint(idOrig.publicFileName);
...
//# sourceMappingURL=identityExchange-test.js.map
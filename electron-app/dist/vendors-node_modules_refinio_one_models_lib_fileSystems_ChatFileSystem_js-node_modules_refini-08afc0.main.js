 ...
 */
exports.id = "vendors-node_modules_refinio_one_models_lib_fileSystems_ChatFileSystem_js-node_modules_refini-08afc0";
exports.ids = ["vendors-node_modules_refinio_one_models_lib_fileSystems_ChatFileSystem_js-node_modules_refini-08afc0"];
exports.modules = {

/***/ "../node_modules/@refinio/one.models/lib/fileSystems/ChatFileSystem.js":
/*!*****************************************************************************!*\
  !*** ../node_modules/@refinio/one.models/lib/fileSystems/ChatFileSystem.js ***!
  \*****************************************************************************/
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ TypesFileSystem)\n/* harmony export */ });\n/* harmony import */ var _refinio_one_core_lib_microdata_to_object_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @refinio/one.core/lib/microdata-to-object.js */ \"../node_modules/@refinio/one.core/lib/microdata-to-object.js\");\n/* harmony import */ var _refinio_one_core_lib_util_object_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @refinio/one.core/lib/util/object.js */ \"../node_modules/@refinio/one.core/lib/util/object.js\");\n/* harmony import */ var _FileSystemHelpers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./FileSystemHelpers.js */ \"../node_modules/@refinio/one.models/lib/fileSystems/FileSystemHelpers.js\");\n/* harmony import */ var _refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @refinio/one.core/lib/errors.js */ \"../node_modules/@refinio/one.core/lib/errors.js\");\n/* harmony import */ var _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./FileSystemErrors.js */ \"../node_modules/@refinio/one.models/lib/fileSystems/FileSystemErrors.js\");\n/* harmony import */ var _refinio_one_core_lib_system_storage_base_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @refinio/one.core/lib/system/storage-base.js */ \"../node_modules/@refinio/one.core/lib/system/storage-base.js\");\n/* harmony import */ var _refinio_one_core_lib_storage_unversioned_objects_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @refinio/one.core/lib/storage-unversioned-objects.js */ \"../node_modules/@refinio/one.core/lib/storage-unversioned-objects.js\");\n\n\n\n\n\n\n\n/**\n * This represents a FileSystem Structure for one objects that can open directories or files on the fly.\n * This class is using {@link FileSystemDirectory} & {@link FileSystemFile} types from {@link IFileSystem} interface in order\n * to accomplish this FileSystem structure.\n */\nclass TypesFileSystem {\n    /**\n     * @global the root of the file system\n     * @type {FileSystemDirectory}\n     * @private\n     */\n    rootDirectory;\n    rootMode = 0o0040755;\n    constructor(rootDirectory = { children: [] }) {\n        this.rootDirectory = rootDirectory;\n    }\n    /**\n     * The current Object File System is not supporting the creation of directories.\n     * @param {string} directoryPath\n     * @param {number} _dirMode\n     * @returns {Promise<FileSystemDirectory>}\n     */\n    createDir(directoryPath, _dirMode) {\n        const rootMode = _FileSystemHelpers_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].retrieveFileMode(this.rootMode);\n        if (!rootMode.permissions.owner.write) {\n            throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-EACCES-W', {\n                message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-EACCES-W'].message,\n                path: directoryPath\n            });\n        }\n        else {\n            throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOSYS', {\n                message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOSYS'].message,\n                functionName: 'createDir()',\n                path: directoryPath\n            });\n        }\n    }\n    /**\n     *\n     * @param {string} filePath\n     * @param {number} length\n     * @param {number} position\n     * @returns {Promise<FileSystemFile>}\n     */\n    async readFileInChunks(filePath, length, position) {\n        if (!this.supportsChunkedReading()) {\n            throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-CHUNK-R', {\n                message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-CHUNK-R'].message,\n                path: filePath\n            });\n        }\n        const content = await this.retrieveContentAboutHash(filePath);\n        if (!content) {\n            throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOENT', {\n                message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOENT'].message,\n                path: filePath\n            });\n        }\n        return {\n            content: TypesFileSystem.stringToUint8Array(content).slice(position, position + length)\n        };\n    }\n    /**\n     *\n     * @param {string} _path\n     * @returns {boolean}\n     */\n    supportsChunkedReading(_path) {\n        return typeof global !== 'undefined' && {}.toString.call(global) === '[object global]';\n    }\n    /**\n     * The current Object File System is not supporting the creation of files.\n     * @param {string} directoryPath\n     * @param {SHA256Hash<BLOB>} _fileHash\n     * @param {string} _fileName\n     * @param {number} _fileMode\n     * @returns {Promise<FileSystemFile>}\n     */\n    async createFile(directoryPath, _fileHash, _fileName, _fileMode) {\n        const rootMode = _FileSystemHelpers_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].retrieveFileMode(this.rootMode);\n        if (!rootMode.permissions.owner.write) {\n            throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-EACCES-W', {\n                message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-EACCES-W'].message,\n                path: directoryPath\n            });\n        }\n        else {\n            throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOSYS', {\n                message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOSYS'].message,\n                functionName: 'createFile()',\n                path: directoryPath\n            });\n        }\n    }\n    /**\n     * Open directory. Paths are checked since it is a FS built on-the-fly.\n     * @param {string} dirPath\n     * @returns {Promise<FileSystemDirectory | undefined>}\n     */\n    async readDir(dirPath) {\n        const parsedPath = this.parsePath(dirPath);\n        /** if it is the root path **/\n        if (!parsedPath.type) {\n            const allHashes = await (0,_refinio_one_core_lib_system_storage_base_js__WEBPACK_IMPORTED_MODULE_5__.listAllObjectHashes)();\n            const types = [];\n            for (const hash of allHashes) {\n                const type = await (0,_refinio_one_core_lib_system_storage_base_js__WEBPACK_IMPORTED_MODULE_5__.getFileType)(hash);\n                if (!types.includes(type)) {\n                    types.push(type);\n                }\n            }\n            return { children: types };\n        }\n        /** in type folder **/\n        if (!parsedPath.hash) {\n            const hashes = await this.retrieveHashesForType(parsedPath.type);\n            return { children: hashes };\n        }\n        if (parsedPath.suffix === '/' || parsedPath.suffix === '') {\n            /** different behaviour for BLOB and CLOB **/\n            if (parsedPath.type === 'BLOB' || parsedPath.type === 'CLOB') {\n                return await TypesFileSystem.returnDirectoryContentForBLOBS();\n            }\n            else if (parsedPath.type === 'Plan') {\n                return await TypesFileSystem.returnDirectoryContentForPlans();\n            }\n            else {\n                return await TypesFileSystem.returnDirectoryContentForRegularObject();\n            }\n        }\n        throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOENT', { message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOENT'].message, path: dirPath });\n    }\n    /**\n     * Opens the file on-the-fly.\n     * @param {string} filePath\n     * @returns {Promise<FileSystemFile | undefined>}\n     */\n    async readFile(filePath) {\n        const content = await this.retrieveContentAboutHash(filePath);\n        if (!content) {\n            throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOENT', {\n                message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOENT'].message,\n                path: filePath\n            });\n        }\n        return {\n            content: TypesFileSystem.stringToUint8Array(content)\n        };\n    }\n    /**\n     *\n     * @param {string} path\n     * @returns {Promise<void>}\n     */\n    async exists(path) {\n        const parsedPath = this.parsePath(path);\n        if (parsedPath.hash) {\n            /** check if the hash exists **/\n            await (0,_refinio_one_core_lib_storage_unversioned_objects_js__WEBPACK_IMPORTED_MODULE_6__.getObject)(parsedPath.hash).catch(_err => {\n                return false;\n            });\n            return true;\n        }\n        /** check if its one of those hardcoded file's name **/\n        return !(parsedPath.suffix &&\n            !['raw.txt', 'type.txt', 'pretty.html', 'json.txt', 'moduleHash.txt'].includes(parsedPath.suffix));\n    }\n    /**\n     *\n     * @param {string} path\n     * @returns {Promise<FileDescription>}\n     */\n    async stat(path) {\n        const parsedPath = this.parsePath(path);\n        if (parsedPath.isRoot || parsedPath.suffix === '/' || parsedPath.suffix === '') {\n            return { mode: this.rootMode, size: 0 };\n        }\n        if (parsedPath.suffix === '/raw.txt' ||\n            parsedPath.suffix === '/pretty.html' ||\n            parsedPath.suffix === '/json.txt' ||\n            parsedPath.suffix === '/type.txt') {\n            const file = await this.readFile(path);\n            if (file) {\n                return { mode: 0o0100444, size: file.content.byteLength };\n            }\n        }\n        if (parsedPath.suffix === '/moduleHash.txt') {\n            return { mode: 0o0120000, size: 0 };\n        }\n        throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOENT', { message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOENT'].message, path: path });\n    }\n    /**\n     * Parses the given path.\n     * @param {string} path\n     * @returns {ParsedObjectsPath}\n     * @private\n     */\n    parsePath(path) {\n        if (path === '/') {\n            return {\n                isRoot: true,\n                hash: null,\n                type: null,\n                suffix: null\n            };\n        }\n        const [_empty, type, hash, ...rest] = path.split('/');\n        if (!type) {\n            return {\n                isRoot: true,\n                hash: null,\n                type: null,\n                suffix: ''\n            };\n        }\n        if (!hash) {\n            return {\n                isRoot: false,\n                hash: null,\n                type: type,\n                suffix: '/'\n            };\n        }\n        const hashRegex = /^([0-9A-Fa-f]{64})$/;\n        const isHash = hash.match(hashRegex);\n        if (!isHash) {\n            return {\n                isRoot: false,\n                hash: null,\n                type: type,\n                suffix: '/'\n            };\n        }\n        return {\n            isRoot: false,\n            hash: hash,\n            type: type,\n            suffix: rest && rest.length > 0 ? `/${rest.join('/')}` : null\n        };\n    }\n    /**\n     * Not implemented because of Read Only FS\n     * @param pathName\n     * @param _mode\n     */\n    chmod(pathName, _mode) {\n        throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOSYS', {\n            message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOSYS'].message,\n            functionName: 'chmod()',\n            path: pathName\n        });\n    }\n    /**\n     * Not implemented because of Read Only FS\n     * @param src\n     * @param _dest\n     */\n    rename(src, _dest) {\n        throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOSYS', {\n            message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOSYS'].message,\n            functionName: 'rename()',\n            path: src\n        });\n    }\n    /**\n     * Not implemented because of Read Only FS\n     * @param pathName\n     */\n    rmdir(pathName) {\n        throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOSYS', {\n            message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOSYS'].message,\n            functionName: 'rmdir()',\n            path: pathName\n        });\n    }\n    /**\n     * Not implemented because of Read Only FS\n     * @param pathName\n     */\n    unlink(pathName) {\n        throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOSYS', {\n            message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOSYS'].message,\n            functionName: 'unlink()',\n            path: pathName\n        });\n    }\n    // ---------------------------------------- Private ----------------------------------------\n    /**\n     * Retrieves directory content for blob hashes.\n     * @returns {Promise<FileSystemDirectory>}\n     * @private\n     */\n    static async returnDirectoryContentForBLOBS() {\n        return {\n            children: ['raw', 'type']\n        };\n    }\n    /**\n     * Retrieves directory content for Plan hashes.\n     * @returns {Promise<FileSystemDirectory>}\n     * @private\n     */\n    static async returnDirectoryContentForPlans() {\n        return {\n            children: ['raw.txt', 'pretty.html', 'json.txt', 'type.txt', 'moduleHash.txt']\n        };\n    }\n    /**\n     * Retrieves directory content for regular hashes.\n     * @returns {Promise<FileSystemDirectory>}\n     * @private\n     */\n    static async returnDirectoryContentForRegularObject() {\n        return {\n            children: ['raw.txt', 'pretty.html', 'json.txt', 'type.txt']\n        };\n    }\n    /**\n     * Converts string to an Array Buffer.\n     * @param {string} str\n     * @returns {ArrayBuffer}\n     * @private\n     */\n    static stringToUint8Array(str) {\n        const buf = new ArrayBuffer(str.length * 2); // 2 bytes for each char\n        const bufView = new Uint8Array(buf);\n        for (let i = 0, strLen = str.length; i < strLen; i++) {\n            bufView[i] = str.charCodeAt(i);\n        }\n        return bufView;\n    }\n    /**\n     * @returns {Promise<SHA256Hash<HashTypes>[]>}\n     * @private\n     */\n    async retrieveHashesForType(type) {\n        const allHashes = await (0,_refinio_one_core_lib_system_storage_base_js__WEBPACK_IMPORTED_MODULE_5__.listAllObjectHashes)();\n        const hashes = [];\n        for (const hash of allHashes) {\n            if ((await (0,_refinio_one_core_lib_system_storage_base_js__WEBPACK_IMPORTED_MODULE_5__.getFileType)(hash)) === type) {\n                hashes.push(hash);\n            }\n        }\n        return hashes;\n    }\n    /**\n     * Utility function to return the right data format for different paths.\n     * @param path\n     */\n    async retrieveContentAboutHash(path) {\n        const parsedPath = this.parsePath(path);\n        const fileType = await (0,_refinio_one_core_lib_system_storage_base_js__WEBPACK_IMPORTED_MODULE_5__.getFileType)(parsedPath.hash);\n        if (fileType === 'BLOB') {\n            return '[binary file - cannot display contents]';\n        }\n        if (parsedPath.suffix === '/raw.txt') {\n            return await (0,_refinio_one_core_lib_system_storage_base_js__WEBPACK_IMPORTED_MODULE_5__.readUTF8TextFile)(parsedPath.hash);\n        }\n        if (parsedPath.suffix === '/pretty.html') {\n            if (fileType === 'CLOB') {\n                return '[Not a ONE object microdata file - cannot display contents as HTML]';\n            }\n            return TypesFileSystem.stringifyXML(await (0,_refinio_one_core_lib_system_storage_base_js__WEBPACK_IMPORTED_MODULE_5__.readUTF8TextFile)(parsedPath.hash));\n        }\n        if (parsedPath.suffix === '/json.txt') {\n            if (fileType === 'CLOB') {\n                return '[Not a ONE object microdata file - cannot display contents as JSON]';\n            }\n            if (parsedPath.hash === null) {\n                throw new Error(`parsedPath.hash is null in ${JSON.stringify(parsedPath)}`);\n            }\n            const microdata = await (0,_refinio_one_core_lib_system_storage_base_js__WEBPACK_IMPORTED_MODULE_5__.readUTF8TextFile)(parsedPath.hash);\n            const obj = (0,_refinio_one_core_lib_util_object_js__WEBPACK_IMPORTED_MODULE_1__.isIdObjMicrodata)(microdata)\n                ? (0,_refinio_one_core_lib_microdata_to_object_js__WEBPACK_IMPORTED_MODULE_0__.convertIdMicrodataToObject)(microdata)\n                : (0,_refinio_one_core_lib_microdata_to_object_js__WEBPACK_IMPORTED_MODULE_0__.convertMicrodataToObject)(microdata);\n            return JSON.stringify(obj, null, '  ');\n        }\n        if (parsedPath.suffix === '/type.txt') {\n            if (parsedPath.hash === null) {\n                throw new Error(`parsedPath.hash is null in ${JSON.stringify(parsedPath)}`);\n            }\n            return await (0,_refinio_one_core_lib_system_storage_base_js__WEBPACK_IMPORTED_MODULE_5__.getFileType)(parsedPath.hash);\n        }\n        return undefined;\n    }\n    /**\n     * Prettify a given xml format as string\n     * @static\n     * @param {string} xmlFormat\n     * @returns {string}\n     * @private\n     */\n    static stringifyXML(xmlFormat) {\n        /** variables **/\n        let deepLevel = 0;\n        let accumulator = '';\n        let index = 0;\n        const xmlAsArray = xmlFormat.split(RegExp('(<.*?>)|(.+?(?=<|$))')).filter(value => value);\n        for (const value of xmlAsArray) {\n            /** if it reached the end **/\n            if (index === xmlAsArray.length - 1) {\n                accumulator += value + '\\n';\n            }\n            else if (value.includes('<') && !value.includes('</')) {\n                /** if it reached the start of a statement. see '<' **/\n                let ident = '';\n                for (let i = 0; i < deepLevel; i++) {\n                    ident += '   ';\n                }\n                deepLevel++;\n                accumulator += ident + value + '\\n';\n            }\n            else if (value.includes('</')) {\n                /** if it reached the end of a statement **/\n                let ident = '';\n                for (let i = 0; i < deepLevel; i++) {\n                    ident += '   ';\n                }\n                accumulator += ident + value + '\\n';\n            }\n            else {\n                /** in between **/\n                let ident = '';\n                for (let i = 0; i < deepLevel; i++) {\n                    ident += '   ';\n                }\n                deepLevel--;\n                accumulator += ident + value + '\\n';\n            }\n            index++;\n        }\n        /** return the prettified xml **/\n        return accumulator;\n    }\n    /**\n     * Not implemented\n     * @param {string} src\n     * @param {string} _dest\n     * @returns {Promise<void>}\n     */\n    symlink(src, _dest) {\n        throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOSYS', {\n            message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOSYS'].message,\n            functionName: 'symlink()',\n            path: src\n        });\n    }\n    /**\n     * Not implemented\n     * @param {string} filePath\n     * @returns {Promise<number>}\n     */\n    readlink(filePath) {\n        throw (0,_refinio_one_core_lib_errors_js__WEBPACK_IMPORTED_MODULE_3__.createError)('FSE-ENOSYS', {\n            message: _FileSystemErrors_js__WEBPACK_IMPORTED_MODULE_4__.FS_ERRORS['FSE-ENOSYS'].message,\n            functionName: 'readLink()',\n            path: filePath\n        });\n    }\n}\n//# sourceMappingURL=TypesFileSystem.js.map\n\n//# sourceURL=webpack://one-filer-login/../node_modules/@refinio/one.models/lib/fileSystems/TypesFileSystem.js?\n}");

/***/ }),

/***/ "../node_modules/@refinio/one.models/lib/fileSystems/utils/DebugDataFormatters.js":
/*!****************************************************************************************!*\
  !*** ../node_modules/@refinio/one.models/lib/fileSystems/utils/DebugDataFormatters.js ***!
  \****************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   prettifyPersonsWithKeysAndInstances: () => (/* binding */ prettifyPersonsWithKeysAndInstances),\n/* harmony export */   prettifySomeoneWithKeysAndInstances: () => (/* binding */ prettifySomeoneWithKeysAndInstances)\n/* harmony export */ });\n/* harmony import */ var _refinio_one_core_lib_storage_unversioned_objects_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @refinio/one.core/lib/storage-unversioned-objects.js */ \"../node_modules/@refinio/one.core/lib/storage-unversioned-objects.js\");\n/* harmony import */ var _refinio_one_core_lib_keychain_keychain_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @refinio/one.core/lib/keychain/keychain.js */ \"../node_modules/@refinio/one.core/lib/keychain/keychain.js\");\n/* harmony import */ var _misc_instance_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../misc/instance.js */ \"../node_modules/@refinio/one.models/lib/misc/instance.js\");\n\n\n\nasync function prettifyKeys(hash, complete, deflt) {\n    const keys = await (0,_refinio_one_core_lib_storage_unversioned_objects_js__WEBPACK_IMPORTED_MODULE_0__.getObject)(hash);\n    return {\n        complete: complete,\n        default: deflt,\n        publicEncryptionKey: keys.publicKey,\n        publicSignKey: keys.publicSignKey\n    };\n}\nasync function prettifyKeysForOwner(owner) {\n    const keys = await (0,_refinio_one_core_lib_keychain_keychain_js__WEBPACK_IMPORTED_MODULE_1__.getListOfKeys)(owner);\n    const prettyKeysArray = await Promise.all(keys.map(async function (key) {\n        return [key.keys, await prettifyKeys(key.keys, key.complete, key.default)];\n    }));\n    const prettyKeysList = {};\n    for (const prettyKeys of prettyKeysArray) {\n        prettyKeysList[prettyKeys[0]] = prettyKeys[1];\n    }\n    return prettyKeysList;\n}\nasync function prettifyInstanceWithKeys(instance, local) {\n    return {\n        local,\n        keys: await prettifyKeysForOwner(instance)\n    };\n}\nasync function prettifyInstancesWithKeysForOwner(owner) {\n    const instances = await (0,_misc_instance_js__WEBPACK_IMPORTED_MODULE_2__.getInstancesOfPerson)(owner);\n    const prettyInstances = await Promise.all(instances.map(async function (instance) {\n        return [\n            instance.instanceId,\n            await prettifyInstanceWithKeys(instance.instanceId, instance.local)\n        ];\n    }));\n    const prettyInstanceList = {};\n    for (const prettyInstance of prettyInstances) {\n        prettyInstanceList[prettyInstance[0]] = prettyInstance[1];\n    }\n    return prettyInstanceList;\n}\nasync function prettifyPersonWithKeysAndInstancesWithKeys(person, main) {\n    return {\n        main,\n        keys: await prettifyKeysForOwner(person),\n        instances: await prettifyInstancesWithKeysForOwner(person)\n    };\n}\nasync function prettifyPersonsWithKeysAndInstances(persons) {\n    const prettyPersons = await Promise.all(persons.map(async function (person) {\n        return [\n            person.personId,\n            await prettifyPersonWithKeysAndInstancesWithKeys(person.personId, person.main)\n        ];\n    }));\n    const prettyPersonList = {};\n    for (const prettyPerson of prettyPersons) {\n        prettyPersonList[prettyPerson[0]] = prettyPerson[1];\n    }\n    return prettyPersonList;\n}\n// ######## Someones ########\nasync function prettifySomeoneWithKeysAndInstances(someone) {\n    const mainId = await someone.mainIdentity();\n    const identities = someone.identities();\n    return prettifyPersonsWithKeysAndInstances(identities.map(identity => ({\n        personId: identity,\n        main: identity === mainId\n    })));\n}\n//# sourceMappingURL=DebugDataFormatters.js.map\n\n//# sourceURL=webpack://one-filer-login/../node_modules/@refinio/one.models/lib/fileSystems/utils/DebugDataFormatters.js?\n}");

/***/ }),

/***/ "../node_modules/@refinio/one.models/lib/fileSystems/utils/EasyFileSystem.js":
/*!***********************************************************************************!*\
  !*** ../node_modules/@refinio/one.models/lib/fileSystems/utils/EasyFileSystem.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("{\n\nmodule.exports = function paethPredictor(left, above, upLeft) {\n  let paeth = left + above - upLeft;\n  let pLeft = Math.abs(paeth - left);\n  let pAbove = Math.abs(paeth - above);\n  let pUpLeft = Math.abs(paeth - upLeft);\n\n  if (pLeft <= pAbove && pLeft <= pUpLeft) {\n    return left;\n  }\n  if (pAbove <= pUpLeft) {\n    return above;\n  }\n  return upLeft;\n};\n\n\n//# sourceURL=webpack://one-filer-login/../node_modules/pngjs/lib/paeth-predictor.js?\n}");
...
eval("{/**\n * Check if QR Code version is valid\n *\n * @param  {Number}  version QR Code version\n * @return {Boolean}         true if valid version, false otherwise\n */\nexports.isValid = function isValid (version) {\n  return !isNaN(version) && version >= 1 && version <= 40\n}\n\n\n//# sourceURL=webpack://one-filer-login/../node_modules/qrcode/lib/core/version-check.js?\n}");
...
eval("{const svgTagRenderer = __webpack_require__(/*! ./svg-tag */ \"../node_modules/qrcode/lib/renderer/svg-tag.js\")\n\nexports.render = svgTagRenderer.render\n\nexports.renderToFile = function renderToFile (path, qrData, options, cb) {\n  if (typeof cb === 'undefined') {\n    cb = options\n    options = undefined\n  }\n\n  const fs = __webpack_require__(/*! fs */ \"fs\")\n  const svgTag = exports.render(qrData, options)\n\n  const xmlStr = '<?xml version=\"1.0\" encoding=\"utf-8\"?>' +\n    '<!DOCTYPE svg PUBLIC \"-//W3C//DTD SVG 1.1//EN\" \"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd\">' +\n    svgTag\n\n  fs.writeFile(path, xmlStr, cb)\n}\n\n\n//# sourceURL=webpack://one-filer-login/../node_modules/qrcode/lib/renderer/svg.js?\n}");
...
eval("{const big = __webpack_require__(/*! ./terminal/terminal */ \"../node_modules/qrcode/lib/renderer/terminal/terminal.js\")\nconst small = __webpack_require__(/*! ./terminal/terminal-small */ \"../node_modules/qrcode/lib/renderer/terminal/terminal-small.js\")\n\nexports.render = function (qrData, options, cb) {\n  if (options && options.small) {\n    return small.render(qrData, options, cb)\n  }\n  return big.render(qrData, options, cb)\n}\n\n\n//# sourceURL=webpack://one-filer-login/../node_modules/qrcode/lib/renderer/terminal.js?\n}");

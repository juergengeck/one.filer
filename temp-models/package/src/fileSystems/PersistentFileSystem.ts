...
import {readBlobAsArrayBuffer, readBlobAsUint8Array, storeArrayBufferAsBlob} from '@refinio/one.core/lib/storage-blob.js';
import {
    getObject,
...
export default class PersistentFileSystem implements IFileSystem {
    ...
    public async readFile(filePath: string): Promise<FileSystemFile> {
        ...
        const fileContent = await readBlobAsUint8Array(blobHash);

...
describe('Password recovery test over server', () => {
    ...
    it('Standard workflow', async () => {
        const waitForRequestPromise = new Promise((resolve, reject) => {
        ...
        const recoveredSecret = await client.recoverSecretAsString(recoveryInformation.symmetricKey);
        expect(recoveredSecret).to.be.equal(secret);
    });
});
//# sourceMappingURL=PasswordRecoveryClient-test.js.map
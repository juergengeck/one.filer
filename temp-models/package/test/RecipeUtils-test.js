...
import { addRule, cloneRule, getRule, hasRule, overwriteRule, removeRule } from '../lib/recipes/RecipeUtils.js';
describe('RulesTest', () => {
    it('cloneRule', function () {
        ...
        expect(getRule(orig, 'three1.two2.one3')).not.to.be.equal(getRule(clone, 'three1.two2.one3'));
        expect(getRule(orig, 'three1.two2.two3')).not.to.be.equal(getRule(clone, 'three1.two2.two3'));
    ...
    it('addRemoveRule', function () {
        ...
        expect(() => addRule(rules, 'three1.two2', {
            itemprop: 'one3',
            optional: true
        })).to.throw;
        ...
        expect(() => overwriteRule(rules, 'three1.two2', {
            itemprop: 'nothing',
            optional: true
        })).to.throw;
    });
});
//# sourceMappingURL=RecipeUtils-test.js.map
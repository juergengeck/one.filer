...
import { getObjectByIdObj, storeVersionObjectAsChange } from '@refinio/one.core/lib/storage-versioned-objects.js';
...
describe('AccessRights model test', () => {
    ...
    it('should add person to an access group', async () => {
        const newPerson = await storeVersionObjectAsChange({
            $type$: 'Person',
...
//# sourceMappingURL=AccessRights-test.js.map
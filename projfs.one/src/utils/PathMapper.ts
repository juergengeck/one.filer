...
export class PathMapper {
     ...
     */
    toVirtualPath(relativePath: string): string {
     ...
     */
    toWindowsPath(virtualPath: string): string {
     ...
     */
    getParent(virtualPath: string): string {
     ...
     */
    getFilename(virtualPath: string): string {
        if (virtualPath === '/' || !virtualPath) {
            return '';
        }
     ...
     */
    isRoot(virtualPath: string): boolean {

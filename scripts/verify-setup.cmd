...
if %errorlevel% neq 0 (
    echo ⚠️  Debian not installed - need to install WSL2 Debian
    goto :debian_missing
)
...
echo 2. Configure and test one.leute.replicant
echo.
goto :end

:debian_missing
echo.
echo Debian is not installed. Please:
echo 1. Run: wsl --install -d Debian
